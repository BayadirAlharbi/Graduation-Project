...
--
-- Host: 127.0.0.1
-- Generation Time: 29 مايو 2022 الساعة 01:41
...
(411, '2022-05-27 23:35:53', 'Needs an inspection visit,Projector', 'solved', 'Problem in projector.', NULL, '106', 101),
(412, '2022-05-27 23:38:24', 'Needs an inspection visit,PC', 'Under Processing', 'This computers do not work.', NULL, '1', 101),
(413, '2022-05-27 23:39:09', 'Needs an inspection visit,Air conditiong', 'Not Processed', 'Air conditioning.', NULL, '112', 101),
(414, '2022-05-27 23:43:30', 'Needs an inspection visit', 'Not Processed', 'The window is broken.', '../uploads/BrokenWin.png', '304', 101),
(418, '2022-05-28 00:42:07', 'Needs an inspection visit,PC', 'solved', 'Computers do not work.', '../uploads/computer damage.jpeg', '312', 101);
...
--
-- إرجاع أو استيراد بيانات الجدول `complaintpcid`
--

INSERT INTO `complaintpcid` (`compID`, `pcID`) VALUES
(412, 1006),
(412, 1009),
(418, 31206),
(418, 31207);
...
--
ALTER TABLE `complaint`
  MODIFY `complaintId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=419;
